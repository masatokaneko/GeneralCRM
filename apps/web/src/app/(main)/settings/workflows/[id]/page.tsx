  ...
  useEffect(() => {
    if (workflow) {
      setFormData({
        ...
        evaluationCriteria: workflow.evaluationCriteria,
      ...
      setFilterLogic(workflow.filterLogic || "");
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold">Edit Workflow Rule</h1>
          <p className="text-muted-foreground">
            Modify the workflow rule settings and actions
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <Button
          onClick={handleSave}
          disabled={!isValid || updateWorkflow.isPending}
        >
